<template>
  <transition name="aside-tab">
    <aside class="aside-tab" id="login-aside">
      ...
      <div id="login-wrap">
        <div class="logo">
          <img src="../assets/logo_2.png" alt="云心网络工作室" />
        </div>
        <section>
            ...
            <div class="login-username">
              ...
              <div>
                <input
                  v-model="username"
                  placeholder="请输入账号"
                  class="input-content color-black"
        ...
        <footer>
          <div class="contact color-green">
            联系我们：<a
              href="mailto:support@yunxin.plus"
              title="联系我们"
              class="color-green"
              >support@yunxin.plus</a
            >
          </div>
        </footer>
      </div>
...
#login-form .input-content {
  border: none;
  border-bottom: 1px solid #acb961;
  padding: 10px 0;
  width: 100%;
  outline: none;
  font-size: 16px;
...
#login-form .login-submit input:disabled {
